...
// this part of the program has programs to calculate the matrix 
//    inverse, eigenvalues, eigenvectors.

// it was added to the program to make the compiling simpler for the 
//    user.
...
int inverse_of_matrix(int n, double a[], double w[], int matz, double z[])
